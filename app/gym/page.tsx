            ...
            <div className="overflow-auto flex-1 p-2">
              {viewingFile.rows && viewingFile.rows.length > 0 ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-xs text-tm-text-3 mt-1">
                    This file was uploaded before content storage was enabled, so its rows were never captured.
                    Its metrics are already applied to the squad table. Re-upload the file to enable in-app viewing and download.
                  </p>
                </div>
              )}
            </div>
