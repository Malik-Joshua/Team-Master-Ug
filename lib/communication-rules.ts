...
export type UserRole = 'player' | 'coach' | 'data_admin' | 'physio' | 'admin' | 'finance_admin' | 'club_captain'
...
export const COMMUNICATION_RULES: Record<UserRole, UserRole[]> = {
  // Players can communicate with: club captain, data manager, coach, physio
  player: ['club_captain', 'data_admin', 'coach', 'physio'],
  
  // Data manager can communicate with: players, coaches, physio, club captain, admin
  data_admin: ['player', 'coach', 'physio', 'club_captain', 'admin'],
  
  // Physio can communicate with: coaches, players, data manager, club captain
  physio: ['coach', 'player', 'data_admin', 'club_captain'],
  
  // Admin can communicate with: players, data manager, coaches, club captain, finance admin
  admin: ['player', 'data_admin', 'coach', 'club_captain', 'finance_admin'],
